...
- **배포와 Alembic** — 배포와 Alembic 마이그레이션을 다른 팀원들이 담당해줘서 제 역할에 집중할 수 있었지만, 개발 과정에서 그 중요성을 실감하며 직접 해보고 싶고 관심이 생겼습니다. 이후 미배포 상태로 남아있던 팀 프로젝트 하나를 개인적으로 배포해보는 계기가 됐습니다. → [프로젝트명](링크)
